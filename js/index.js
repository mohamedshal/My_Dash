...
let sideBarHead = document.querySelector(".sidebar h3");
let sideBarHeadSpans = document.querySelectorAll(".sidebar h3 span");
//
let sideBarLists = document.querySelectorAll(".sidebar ul li a");
let sideBarSpans = document.querySelectorAll(".sidebar ul li a span");
let toggleDash = document.querySelector(".sidebar .baricon");

toggleDash.onclick = function() {
    sideBar.classList.toggle("bartog");
    sideBarHead.classList.toggle("headtog");
    sideBarHeadSpans.forEach((span) => {
        span.classList.toggle("spantog");
    })
    sideBarLists.forEach((list) => {
        list.classList.toggle("listtog");
    });
